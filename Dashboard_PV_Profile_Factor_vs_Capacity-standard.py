...
plt.savefig('pv_profile_factor_vs_capacity_dashboard_standard.svg', format='svg', bbox_inches='tight')
...
print(f"  - SVG: pv_profile_factor_vs_capacity_dashboard_standard.svg")
