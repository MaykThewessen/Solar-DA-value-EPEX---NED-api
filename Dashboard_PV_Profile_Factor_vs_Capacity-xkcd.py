...
fig.update_layout(
    title=dict(
        ...
        x=0.5,
        font=dict(size=20, family='Comic Sans MS, cursive')
    ),
    xaxis=dict(
        title=dict(text='Installed PV Capacity NL (GWp DC) yearly avg', font=dict(size=18, family='Comic Sans MS, cursive')),
        tickfont=dict(size=16, family='Comic Sans MS, cursive'),
        gridcolor='lightgray',
        zeroline=False,
        range=[0, 100],
        showgrid=True,
    ...
    yaxis=dict(
        title=dict(text='Profile Factor (%)', font=dict(size=18, family='Comic Sans MS, cursive')),
        tickfont=dict(size=16, family='Comic Sans MS, cursive'),
        gridcolor='lightgray',
        zeroline=False,
        range=[0, 105],
    ...
    legend=dict(
        title='Year',
        font=dict(size=16, family='Comic Sans MS, cursive')
    ),
    plot_bgcolor='white',
    paper_bgcolor='white',
    width=1200,
    ...
    # Add xkcd style configuration
    font=dict(family='Comic Sans MS, cursive'),
...
if len(plot_data) > 2:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            mode='lines',
            name='Linear Trend',
            line=dict(color='red', width=6, shape='spline', smoothing=0.3),
        ...
        if b < 0:  # Only for decay (negative slope)
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    line=dict(color='red', width=6, dash='dot', shape='spline', smoothing=0.3),
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    line=dict(color='orange', width=6, dash='dash', shape='spline', smoothing=0.3),
                ...
                if threshold < a_adjusted:  # Only show if threshold is below the starting value
                    ...
                    if x_at_threshold <= 200:  # Only show if within our plot range
                        fig.add_annotation(
                            ...
                            ax=20,
                            ay=-20,
                            font=dict(size=15, color='orange', family='Comic Sans MS, cursive'),
            ...
            fig.add_annotation(
                ...
                ax=80,
                ay=-20,
                font=dict(size=16, color='red', family='Comic Sans MS, cursive'),
                bgcolor='rgba(255,255,255,0.8)',
                bordercolor='red',
                borderwidth=2
            )
            ...
            fig.add_annotation(
                ...
                ax=80,
                ay=-30,
                font=dict(size=17, color='black', family='Comic Sans MS, cursive'),
            ...
            fig.add_annotation(
                ...
                showarrow=False,
                font=dict(size=16, color='orange', family='Comic Sans MS, cursive'),
...
for i, row in plot_data.iterrows():
    ...
    fig.add_trace(
        go.Scatter(
            ...
            textfont=dict(size=16, color='white', family='Comic Sans MS, cursive'),
            name=f'{int(year)}',
...
if len(plot_data) > 2:
    ...
    fig.add_annotation(
        ...
        font=dict(size=18, color='red', family='Comic Sans MS, cursive'),
        bgcolor='rgba(255,255,255,0.8)',
        bordercolor='red',
        borderwidth=2
    )
...
fig.write_html('pv_profile_factor_vs_capacity_dashboard_xkcd.html', auto_open=True)
fig.write_image('pv_profile_factor_vs_capacity_dashboard_xkcd.pdf', format='pdf')

print(f"\nDashboard created:")
print(f"  - HTML: pv_profile_factor_vs_capacity_dashboard_xkcd.html")
